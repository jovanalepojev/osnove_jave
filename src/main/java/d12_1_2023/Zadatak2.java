...
//    Racun na: Ime i prezime  -  broj racuna
    ...
    public static void main(String[] args) {
        ...
        Racun r1 = new Racun("7569-6548-666", "Marko Markovic", 17500);
        Racun r2 = new Racun("7882-1458-748", "Petar Petrovic", 56400);
        Transakcija t1 = new Transakcija(74856, r2,r1);

       t1.izvrsiTransakciju(1200);
